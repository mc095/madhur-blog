...
export default function SecretBlogEditor() {
  ...
  const handleSubmit = async (e) => {
    ...
    const postData = { title, slug, content, excerpt, coverImage };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">{editSlug ? "Edit Blog Post" : "Create New Blog Post"}</h1>
